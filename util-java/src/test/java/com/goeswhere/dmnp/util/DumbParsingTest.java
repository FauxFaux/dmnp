...
public class DumbParsingTest {
	@Test public void testPackageOfSimple() throws IOException {
		assertPackageOf("com.pony.ponies", "package com.pony.ponies;\nclass A {\n\tint a;\n}\n");
	}

	@Test public void testPackageOfComment() throws IOException {
		assertPackageOf("pony", "/** COPYRIGHT */\npackage pony;\nclass A {\n\tint a;\n}\n");
	}

	@Test public void testPackageOfLineComment() throws IOException {
		assertPackageOf("pony", "// COPYRIGHT\npackage pony;\nclass A {\n\tint a;\n}\n");
	}

	@Test public void testPackageOfu() throws IOException {
		assertPackageOf("pony", "// u\npackage pony;\nclass A {\n\tint a;\n}\n");
	}

	@Test public void testPackageOf\u1571() throws IOException {
		assertPackageOf("pon\u1571", "package pon\\u1571;\nclass A {\n\tint a;\n}\n");
	}

	@Test public void testPackageOfNone() throws IOException {
		assertPackageOf(null, "class A {\n\tint a;\n}\n");
	}

	@Test public void testPackageOfCpp() throws IOException {
