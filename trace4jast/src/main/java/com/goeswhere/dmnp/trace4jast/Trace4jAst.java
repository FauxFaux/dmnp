...
public class Trace4jAst extends SimpleFileFixer {
    ...
    public String apply(final String from) {
        ...
        cu.accept(new ASTAllVisitor() {
            ...
            @Override
            public void visitSimpleName(SimpleName sn) {
    ...
    enum BuiltInRewriters implements Rewriter {
        ...
        FINALLY_REWRITER {
            @Override
            public void rewriteMethod(String loggerName, MethodDeclaration md,
        ...
        ENTER_AND_EXTRACT_RETURN {
            @Override
            public void rewriteMethod(final String loggerName, final MethodDeclaration md,
                ...
                md.accept(new ASTAllVisitor() {
                    @Override
                    public void visitReturnStatement(final ReturnStatement rs) {
