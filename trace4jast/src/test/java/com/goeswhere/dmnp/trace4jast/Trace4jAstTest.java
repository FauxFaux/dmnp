...
public class Trace4jAstTest {
    ...
    @Test
    public void simpleExtractReturn() {
    ...
    @Test
    public void testExtractReturnVoid() {
        assertWashes(Trace4jAst.BuiltInRewriters.ENTER_AND_EXTRACT_RETURN,
    ...
    @Test
    public void testExtractReturnThrow() {
        assertWashes(Trace4jAst.BuiltInRewriters.ENTER_AND_EXTRACT_RETURN,
    ...
    @Test
    public void testInnerReturnType() {
        assertWashes(Trace4jAst.BuiltInRewriters.ENTER_AND_EXTRACT_RETURN,
    ...
    @Test
    public void testCommentsBefore() {
        assertWashes(Trace4jAst.BuiltInRewriters.ENTER_AND_EXTRACT_RETURN,
                "class A { int foo() {\n" +
